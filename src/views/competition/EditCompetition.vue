        ...
        <div class="problem-tab-content col-10">
          <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active"
              ...
              <v-md-editor v-model="problem.description"
                           height="400px"
              ...
              <div class="form-option">
                <div class="form-metrics col-3">
                  ...
                  <select class="form-select"
                    ...
                    <option v-for="item in problem.metrics"
                            :key="item"
                    >{{ item }}</option>
                  </select>
                </div>
              ...
              <div class="form-time col-5">
                <div class="form-start-time">
                  ...
                  >시작 시간</label>
                  <Datepicker v-model="problem.startTime"
                              placeholder="시작 시간"
                              textInput />
                </div>
                ...
                <div class="form-end-time">
                  ...
                  <Datepicker v-model="problem.endTime"
                              placeholder="종료 시간"
                              textInput />
                </div>
              </div>
            ...
            <div class="tab-pane fade" id="list-data" role="tabpanel" aria-labelledby="list-data-list" :key="problem">
              ...
              <v-md-editor v-model="problem.data_description"
                           height="400px"
